...
-- Ahora veamos los distintos valores de las columnas que queremos usar como boolean

CREATE TYPE estado_categorico AS ENUM ('SI', 'NO', 'SE IGNORA', 'NO ESPECIFICADO', 'NO APLICA');
